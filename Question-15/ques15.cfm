...
<body>
    ...
    <cfinvoke component="ques15" method="multiply" returnvariable="result1">
    ...
    <cfinvoke component="ques15" method="multiply" returnvariable="result2">
        <cfinvokeargument name="num1" value="1">
        <cfinvokeargument name="num2" value="2">
        <cfinvokeargument name="num3" value="3">
    </cfinvoke>
    <h4>Display Result2 using cfinvoke tag: <cfoutput>#result2#</cfoutput></h4>
    <cfinvoke component="ques15" method="multiply" returnvariable="result3">
        <cfinvokeargument name="num1" value="1">
        <cfinvokeargument name="num2" value="2">
        <cfinvokeargument name="num3" value="3">
    ...
    <cfobject type="component" name="ques15" component="ques15">
    ...
    <cfset ques15 = createObject("component", "ques15")>
